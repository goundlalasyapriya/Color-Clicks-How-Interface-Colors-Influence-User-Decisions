...
print("\nTransformed Shopping Data (first 10 rows):")
print(df_shopping_preprocessed.head(10))
print("\nSummary Statistics of Transformed Shopping Data:")
print(df_shopping_preprocessed.describe())
...
# Filter rows for consistent group and landing_page
...
print("\nTransformed A/B Data (first 10 rows):")
print(df_ab_data_cleaned.head(10))
print("\nA/B Data Info:")
print(df_ab_data_cleaned.info())

# ----------------- Step 9: Save preprocessed data to CSV -----------------
os.makedirs(r"C:\DAV PROGRAM", exist_ok=True)  # ensure folder exists
...
print("\nTransformed datasets saved successfully as:")
